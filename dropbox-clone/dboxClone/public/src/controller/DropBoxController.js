...
class DropBoxController {
  ...
  constructor(){
    ...
    this.onSelectionChancge = new Event('selectionChange');
  ...
  uploadProgress(event, file){
    ...
    this.timeleftEl.innerHTML = this.dateTimeFriendlyFormat(timeleft);


  };

  dateTimeFriendlyFormat(duration){
  ...
  renderNav(){
    ...
    for (let i = 0; i < this.currentFolder.length; i++) {
      ...
      if ((i+1) === this.currentFolder.length) {
        ...
        span.innerHTML = `
        <span class="ue-effect-container uee-BreadCrumbSegment-link-0" wfd-id="19">
    ...
    li.addEventListener('click', e=>{
      ...
      if (e.shiftKey) {
        ...
        if (firstLi){
          ...
          this.listFilesEL.dispatchEvent(this.onSelectionChancge);
